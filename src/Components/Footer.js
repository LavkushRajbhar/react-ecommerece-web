          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <div className='footer-links d-flex flex-column'>
                <Link className="text-white py-2 text-decoration-none">Privacy Policy</Link>
                <Link className="text-decoration-none text-white py-2 ">Refund Policy</Link>
                <Link className="text-decoration-none text-white py-2 ">Shipping Policy</Link>
                <Link className="text-decoration-none text-white py-2">Terms & Condition</Link>
                <Link className="text-decoration-none text-white py-2 mb-1">Bloggs</Link>
